...
class ActionTracker():
    ...
    def __init__(self, ent_tracker):
        ...
        self.am_dict = {
            '00000000' : [ 5, 8 ],
            '11000000' : [ 0, 2, 5, 8, 10, 12],
            '11111000' : [ 0, 2, 5, 6, 7, 8, 9, 10],
            '11111110' : [ 1, 2, 3, 4, 6, 7, 8, 9, 10, 12],
            '00111000' : [ 0, 2, 5, 6, 7, 8, 9, 10, 11, 12],
            '11000110' : [ 0, 2, 3, 4, 6, 7, 8, 9, 10, 12],
            '00011000' : [0,2,5,6,7,8,9,10,11,12],
            '00000000' : [0,2,5,6,7,8,9,10,11,12],
            '00000100' : [0,2,5,6,7],
            '11111011' : [1,3,4,6,7,8],
            '11111111' : [1,2,3,4,6,7,8],
            '11111100' : [0,2,3,5,6,7,8,9,10,12]            
        }
